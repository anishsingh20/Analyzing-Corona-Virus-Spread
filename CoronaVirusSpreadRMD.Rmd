...
hchart(nCOVDate, "spline", hcaes(x = Date,y = nConfirmed), name="Confirmed cases:",color="black") %>% 
  hc_exporting(enabled = TRUE) %>%
      hc_title(text="Increase in number of nCOV cases over time",align="center") %>%
...
hchart(nCOVDate, "spline", hcaes(x = Date,y = nDeath), name="Confirmed deaths:",color="red") %>% 
  hc_exporting(enabled = TRUE) %>%
      hc_title(text="Increase in number of nCOV deaths over time",align="center") %>%
      hc_add_theme(hc_theme_elementary()) 
...
hchart(nCOVDate, "spline", hcaes(x = Date,y = nRecovery), name="Confirmed recoveries:",color="green") %>% 
  hc_exporting(enabled = TRUE) %>%
      hc_title(text="Increase in number of nCOV recoveries over time",align="center") %>%
      hc_add_theme(hc_theme_elementary()) 
...
highchart() %>% 
  ...
  hc_add_theme(hc_theme_elementary()) %>% 
  hc_exporting(enabled = TRUE) %>%
  hc_title(text="Analysis of count of deaths,recoveries and cases for nCOV",align="center")
...
nCOVDateChina <- nCOV %>%
 ...
 highchart() %>% 
        ...
        hc_add_theme(hc_theme_elementary()) %>% 
        hc_exporting(enabled = TRUE) %>%
        hc_title(text="Analysis of count of deaths,recoveries and cases for nCOV in China",align="center")
...
nCOVDateUS <- nCOV %>%
 ...
 highchart() %>% 
        ...
        hc_add_theme(hc_theme_elementary()) %>% 
        hc_exporting(enabled = TRUE) %>%
        hc_title(text="Analysis of count of deaths,recoveries and cases for nCOV in United States",align="center")
...
nCOVDateHK <- nCOV %>%
 ...
 highchart() %>% 
        ...
        hc_add_theme(hc_theme_elementary()) %>% 
        hc_exporting(enabled = TRUE) %>%
        hc_title(text="Analysis of count of deaths,recoveries and cases for nCOV in Hong Kong",align="center")
...
nCOVDateMacau <- nCOV %>%
 ...
 highchart() %>% 
        ...
        hc_add_theme(hc_theme_elementary()) %>% 
        hc_exporting(enabled = TRUE) %>%
        hc_title(text="Analysis of count of deaths,recoveries and cases for nCOV in Macau",align="center")
...
nCOVDateCanada <- nCOV %>%
 ...
 highchart() %>% 
        ...
        hc_add_theme(hc_theme_elementary()) %>% 
        hc_exporting(enabled = TRUE) %>%
        hc_title(text="Analysis of count of deaths,recoveries and cases for nCOV in Canada",align="center")
...
nCOVDateAUS <- nCOV %>%
 ...
 highchart() %>% 
        ...
        hc_add_theme(hc_theme_elementary()) %>% 
        hc_exporting(enabled = TRUE) %>%
        hc_title(text="Analysis of count of deaths,recoveries and cases for nCOV in Australia",align="center")
...
nCOVDateGER <- nCOV %>%
 ...
 highchart() %>% 
        ...
        hc_add_theme(hc_theme_elementary()) %>% 
        hc_exporting(enabled = TRUE) %>%
        hc_title(text="Analysis of count of deaths,recoveries and cases for nCOV in Germany",align="center")
...
hchart(countcountry1 , type = "column", hcaes(x=countcountry1$Country, y= countcountry1$nCases ),color="purple") %>% 
      hc_exporting(enabled = TRUE) %>%
...
hchart(count_recovered , type = "column", hcaes(x = count_recovered$Country , y = count_recovered$RecoveryRate),color="orange",name="Rate:") %>% 
      hc_exporting(enabled = TRUE) %>%
      hc_title(text="Recovery rate of each country out of total nCOV Cases",align="center") %>%
      hc_add_theme(hc_theme_elementary()) 
...
hchart(StateCasesChina, "treemap", hcaes(x =State , value = nConfirmed,color = nConfirmed) ) %>% 
      hc_exporting(enabled = TRUE) %>% 
      hc_title(text="Tree map of States in China and confirmed Cases of nCOV",align="center") %>%
      hc_add_theme(hc_theme_elementary()) 

```

We can notice in the above Tree map that most of the confirmed cases of nCOV virus are in State of __Hubei__ whose capital city is __Wuhan__, as it the city where it all started.
...
hchart(StateCasesChina, "treemap", hcaes(x =State , value = nDeaths,color = nDeaths) ) %>% 
      hc_exporting(enabled = TRUE) %>% 
      hc_title(text="Tree map of States in China and confirmed deaths from nCOV",align="center") %>%
      hc_add_theme(hc_theme_elementary()) 
...
hchart(USState, "pie", hcaes(x =State , y = nConfirmed,color = nConfirmed), name="count:" ) %>% 
      hc_exporting(enabled = TRUE) %>% 
      hc_title(text="Tree map of States in US and confirmed Cases of nCOV",align="center") %>%
      hc_add_theme(hc_theme_elementary()) 
...
hchart(AustraliaState, "pie", hcaes(x =State , y = nConfirmed,color = nConfirmed) ) %>% 
      hc_exporting(enabled = TRUE) %>% 
      hc_title(text="Tree map of States in Australia and confirmed Cases of nCOV",align="center") %>%
      hc_add_theme(hc_theme_elementary()) 
...
hchart(CanadaState, "pie", hcaes(x =State , y = nConfirmed,color = nConfirmed) ) %>% 
      hc_exporting(enabled = TRUE) %>% 
      hc_title(text="Tree map of States in Canada and confirmed Cases of nCOV",align="center") %>%
      hc_add_theme(hc_theme_elementary()) 
